...
flowchart TD
    ...
    KeyResponse --> Compare[POST /api/exam/compare]
...
| `POST /api/exam/compare` | One or more PDFs/images, `exam_id`, provider | `routes/exams.py -> ExamRepository -> ExamComparisonService -> provider` | `ComparisonResult[]` |
