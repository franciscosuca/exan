...
const translations = {
  en: {
    ...
    'app.header.grammarEvaluation': 'Grammar Evaluation',
    'app.logout': 'Logout',
    ...
    'app.landing.grammarEvaluation.title': 'Grammar Evaluation',
    'app.landing.grammarEvaluation.description':
    ...
    'grammarEvaluation.uploadExams': 'Upload Exams',
    'grammarEvaluation.uploadExamsDescription':
      'Upload one or more exams in PDF or Word format. Each file will be evaluated individually.',
    'grammarEvaluation.dropLabel': 'Drop exam files here',
    'grammarEvaluation.dropDescription': 'PDF or Word documents (.pdf, .docx, .doc)',
    'grammarEvaluation.filesSelected': '{count} file(s) selected:',
    'grammarEvaluation.grammarEvaluation': 'Grammar Evaluation',
    'grammarEvaluation.language': 'Language',
    'grammarEvaluation.evaluate': 'Evaluate {count} File{plural}',
    'grammarEvaluation.evaluating': 'Evaluating {count} file(s) with {provider}...',
    'grammarEvaluation.noFiles': 'Please upload at least one file',
    'grammarEvaluation.error': 'Evaluation failed',
    'grammarEvaluation.newEvaluation': 'New Evaluation',

    'grammarResults.title': 'Grammar Evaluation Results',
    'grammarResults.filesEvaluated': '{count} file(s) evaluated',
    'grammarResults.processed': 'Processed {date}',
    'grammarResults.detailedFindings': 'Detailed Findings',
    'grammarResults.originalSentence': 'Original Sentence',
    'grammarResults.correctedSentence': 'Corrected Sentence',
    'grammarResults.noIssues': 'No grammar issues found.',
  ...
  de: {
    ...
    'app.header.grammarEvaluation': 'Grammatikbewertung',
    'app.logout': 'Abmelden',
    ...
    'app.landing.grammarEvaluation.title': 'Grammatikbewertung',
    'app.landing.grammarEvaluation.description':
    ...
    'grammarEvaluation.uploadExams': 'Prüfungen hochladen',
    'grammarEvaluation.uploadExamsDescription':
      'Lade eine oder mehrere Prüfungen im PDF- oder Word-Format hoch. Jede Datei wird einzeln ausgewertet.',
    'grammarEvaluation.dropLabel': 'Prüfungsdateien hier ablegen',
    'grammarEvaluation.dropDescription': 'PDF- oder Word-Dokumente (.pdf, .docx, .doc)',
    'grammarEvaluation.filesSelected': '{count} Datei(en) ausgewählt:',
    'grammarEvaluation.grammarEvaluation': 'Grammatikbewertung',
    'grammarEvaluation.language': 'Sprache',
    'grammarEvaluation.evaluate': '{count} Datei{plural} grammatisch bewerten',
    'grammarEvaluation.evaluating': 'Grammatikbewertung von {count} Datei(en) mit {provider}...',
    'grammarEvaluation.noFiles': 'Bitte lade mindestens eine Datei hoch',
    'grammarEvaluation.error': 'Grammatikbewertung fehlgeschlagen',
    'grammarEvaluation.newEvaluation': 'Neue Grammatikbewertung',

    'grammarResults.title': 'Ergebnisse der Grammatikbewertung',
    'grammarResults.filesEvaluated': '{count} Datei(en) grammatisch bewertet',
    'grammarResults.processed': 'Verarbeitet am {date}',
    'grammarResults.detailedFindings': 'Detaillierte Ergebnisse',
    'grammarResults.originalSentence': 'Originalsatz',
    'grammarResults.correctedSentence': 'Korrigierter Satz',
    'grammarResults.noIssues': 'Keine Grammatikfehler gefunden.',
